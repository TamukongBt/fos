...
<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/home.jpg">
        ...
        <div class="location-match text-xs-center">
            <div class="container"> <span>Tasty Dishes: <span class="primary-color">Deleivery All over Buea</span> </span>
            </div>
        </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular This Month In Buea</h2>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            ...
                            <div class="content">
                                ...
                                <div class="price-btn-block"> <span class="price">FCFA. <?php echo $row['ItemPrice'];?></span>
