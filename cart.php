...
<h6><a href="food-detail.php?fid=<?php echo $_SESSION['fid']=$row['FoodId'];?>"><?php echo $row['ItemName']?> (<?php echo $row['ItemQty']?>) </a></h6>
                                        ...
                                        <!-- end:col -->
                                        <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info"> <span class="price pull-left">FCFA <?php echo $total=$row['ItemPrice']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
?>     
<input type="text" name="orderno" placeholder="City" value="<?php echo $orderno;?>" hidden>            
                                ...
                                <div class="widget-body">
                                    ...
                                    <p>Cost Of Meal : FCFA <?php echo $grandtotal;?></p>
                                    <p>Delivery Fee : FCFA 500 </p>
                                        <p>TOTAL</p>
                                        <h3 class="value"><strong>FCFA <?php echo $grandtotal + 500;?></strong></h3>
                                        ...
                                        <button 
                                            ...
                                            wazapay_merchantId="WaZa6273141264MC" 
                                            wazapay_amount="<?php echo $grandtotal;?>"
											
                                            wazapay_transactionReference="<?php echo $orderno;?>"
